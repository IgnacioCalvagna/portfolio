    ...
    <>
      <div className="total container">
        <div className="tresCuartos">
          <h3>Acerca de mi</h3>
          <p className="sobreMi">Mi nombre es Ignacio Calvagna tengo 28 años, resido en Tigre, Buenos Aires </p>
          <p className="sobreMi">
            Soy estudiate de segundo año de la
            carrera de Analista de Sistemas, egresado del coding bootcamp de
            Plataforma 5 en donde realice un curso de mas de 800 Hs en donde aprendí
            diversas tecnologias desempeñando tareas Front-end y Back-end
